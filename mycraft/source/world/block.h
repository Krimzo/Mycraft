...
using BlockTest = std::function<bool(const BlockPosition&)>;
...
void block_to_quads(const BlockPosition& block_pos, Block block, std::vector<Quad>& out_quads, const BlockTest& block_test);
void pettle_to_quads(const BlockPosition& block_pos, Block block, std::vector<Quad>& out_quads, const BlockTest& block_test);
