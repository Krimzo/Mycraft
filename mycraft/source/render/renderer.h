...
struct Renderer
{
    ...
    dx::RasterState portal_indices_raster;
    ...
    dx::DepthState portal_indices_depth;
    ...
    kl::Shaders portal_indices_shaders;
...
private:
    ...
    void draw_portal_indices( kl::Camera const& camera );
