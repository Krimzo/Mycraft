...
struct ChunkIndex
{
    ...
    constexpr ChunkIndex() : ChunkIndex(0, 0)
    {
    }

    constexpr ChunkIndex(int x, int z) : x(x), z(z)
    {
    }
...
struct ChunkPosition
{
    ...
    constexpr ChunkPosition() : ChunkPosition(0, 0)
    {
    }
...
struct BlockIndex
{
    ...
    constexpr BlockIndex() : BlockIndex(0, 0, 0)
    {
    }

    constexpr BlockIndex(int x, int y, int z) : x(x), y(y), z(z)
    {
    }
...
struct BlockPosition
{
    ...
    constexpr BlockPosition() : BlockPosition(0, 0, 0)
    {
    }
